...
> 本文件收纳 README 的工程细节：项目亮点、功能特性、API 一览、核心设计说明、测试与指标、Docker 部署、CI/CD、开发说明与常见问题。README 只保留「是什么、怎么跑、架构图」。
...
```
.
├── README.md                 # 速览（是什么、怎么跑、架构图）
├── docs/PROJECT.md           # 本文档（工程详情）
...
> 完整契约见 [api-spec.json](../api-spec.json)；与实现之间的已知偏差记录在 [docs/PROGRESS.md](PROGRESS.md) 决策记录中。
...
<p align="center">
  <img src="assets/ci-flow.png" alt="梭子 SORTS CI/CD 流程图" width="95%">
  <br/>
  <em>CI/CD 流程图（点击图片查看原图）</em>
</p>

> 可编辑源文件见 [`assets/ci-flow.html`](assets/ci-flow.html)。
